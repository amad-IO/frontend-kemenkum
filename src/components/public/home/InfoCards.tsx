...
const InfoCards = () => {
  ...
  return (
    <section className="mx-auto grid max-w-[1330px] gap-5 px-6 lg:grid-cols-3 lg:px-0" id="guideline">

      <motion.div
        initial={{ opacity: 0, x: isDesktop ? 0 : 50, y: isDesktop ? 50 : 0 }}
        whileInView={{ opacity: 1, x: 0, y: 0 }}
        transition={{ duration: 0.6, ease: 'easeOut', delay: 0.1 }}
        viewport={{ once: true, margin: '-50px' }}
      >
        <article className="group relative h-full aspect-auto sm:aspect-[3/2] overflow-hidden rounded-[20px] border border-white/70 bg-neutral-card px-5 py-6 shadow-[0_10px_28px_rgba(110,71,59,0.08)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_14px_36px_rgba(110,71,59,0.13)] lg:px-7 lg:py-7">
      ...
      <motion.div
        ...
        viewport={{ once: true, margin: '-50px' }}
      >
        <article className="relative flex h-full aspect-auto sm:aspect-[3/2] overflow-hidden rounded-[20px] border border-white/70 bg-[linear-gradient(145deg,#FAF8F4_0%,#F0E8DE_100%)] px-5 py-6 shadow-[0_10px_28px_rgba(110,71,59,0.08)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_14px_36px_rgba(110,71,59,0.13)] lg:px-7 lg:py-7">
      ...
      <motion.div
        ...
        viewport={{ once: true, margin: '-50px' }}
      >
        <article className="group relative h-full aspect-[3/2] overflow-hidden rounded-[20px] bg-primary-light shadow-[0_10px_28px_rgba(110,71,59,0.12)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_14px_36px_rgba(110,71,59,0.18)]">
          <img
          ...
          />
          <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-primary/95 via-primary/60 to-transparent px-5 pb-6 pt-32 text-neutral-card lg:px-7 lg:pb-7 lg:pt-40">
