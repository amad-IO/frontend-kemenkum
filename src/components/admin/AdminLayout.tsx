...
const AdminLayout = () => {
  ...
  return (
    <div className="flex min-h-screen bg-neutral-bg font-sans">
      ...
      {/* ── Sidebar ── */}
      <aside
        className={`fixed inset-y-0 left-0 z-40 flex w-64 flex-col bg-neutral-card border-r border-neutral-border shadow-soft transition-transform duration-300 lg:static lg:translate-x-0 ${
      ...
      >
        ...
        <div className="flex items-center gap-3 border-b border-neutral-border px-6 py-5">
          <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-primary">
            <span className="text-sm font-extrabold text-white">KH</span>
          </div>
          <div className="leading-tight">
            <p className="text-sm font-extrabold text-neutral-text">Kemenkuham</p>
